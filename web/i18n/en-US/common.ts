const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'OneAI account',
    langGeniusAccountTip: 'Your OneAI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to OneAI to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by OneAI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across OneAI\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'OneAI {{version}} is now available.',
    latestAvailable: 'OneAI {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
